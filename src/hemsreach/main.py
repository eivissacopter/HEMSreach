...
if 'error' in wind_data:
    ...
    # Fetch METAR/TAF data (Assuming you have the function to fetch this data)
    AVWX_API_KEY = "your_avwx_api_key"  # Replace with your actual AVWX API key
    ...
    for airport, distance, bearing, ground_speed_kt, time_to_airport_hours in reachable_airports:
        ...
        if metar_data and taf_data:
            ...
            descent_time_hours = (cruise_altitude_ft - airport_elevation_ft) / descend_performance['descend_rate_fpm'] / 60
            ...
            climb_time_hours = cruise_altitude_ft / climb_performance['climb_rate_fpm'] / 60
            climb_fuel_burn = climb_time_hours * climb_performance['fuel_burn_kgph']

            # Recalculate remaining trip fuel after climb and descent
            remaining_trip_fuel_kg = total_fuel_kg - (climb_fuel_burn + descent_fuel_burn)
